...
```
git clone https://github.com/my-github-username/make-porto-win-european-best-destination-2017
```
...
Add remote upstream
```
git remote add upstream https://github.com/hfreire/make-porto-win-european-best-destination-2017
```
...
The list of outstanding feature requests and bugs can be found in the [GitHub issue tracker](https://github.com/hfreire/make-porto-win-european-best-destination-2017/issues) of this repo. Please, feel free to propose features or report bugs that are not there.
...
Once you generate a pull request, GitHub and third-party apps will verify if the changes are suitable to be merged with upstream. [Travis](https://travis-ci.org/hfreire/make-porto-win-european-best-destination-2017) will verify your changes for style guide violations and failing test cases, while, [Coveralls](https://coveralls.io/github/hfreire/make-porto-win-european-best-destination-2017) will verify the coverage of the automated test cases against the code.
